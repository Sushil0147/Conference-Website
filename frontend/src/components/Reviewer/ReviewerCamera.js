...
const ReviewerCamera = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (validation()) {
            if (data.status < 2) {
                axios.post('http://localhost:5000/reviewer/cameraform', { application_no, comments, marks, reviewer_crn, status },{withCredentials:true})
                    .then((res) => {
        ...
        <>
            ...
            <div className="container d-flex my-5 p-0" style={{ height: "60vh" }} >
                <div className="container  w-50 d-flex align-items-center justify-content-evenly flex-column rounded p-2" style={{ backgroundColor: "#caf0f8" }}>
                    ...
                    <h2 className="fw-bolder mb-3 text-center text-dark">Camera Screening</h2>
                    ...
                    <div className="container d-flex ">
                        ...
                        <div className="col">{data.status > 1 ? "Recommend" : data.status === -1 ? "Not Recommend" : "No Completed"}</div>
                    </div>
                    <div className="container d-flex ">
