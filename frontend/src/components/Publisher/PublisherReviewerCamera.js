...
const PublisherReviewerCamera = () => {
    ...
    useEffect(() => {
        axios.post('http://localhost:5000/publisher/publisherreviewercameradata', { application_no },{withCredentials:true})
            .then((res) => {
                setData(res.data[0]);
    ...
    return (
        ...
        <>
            ...
            <div className="container-fluid d-flex flex-column justify-content-center align-items-center" style={{ height: "100vh", backgroundColor: "#caf0f8" }}>
                <h1 className='mb-3'>Camera Screening</h1>
...
export default PublisherReviewerCamera;
